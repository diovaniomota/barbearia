...
class BarbeariaColors {
  ...
  static const List<Map<String, String>> colorPalette = [
    {
      'name': 'Saddle Brown (Primary)',
      'hex': '#8B4513',
      'usage': 'Cor principal, botões importantes',
    },
    {
      'name': 'Brown (Secondary)',
      'hex': '#795548',
      'usage': 'Cor secundária, elementos de apoio',
    },
    {
      'name': 'Light Tan',
      'hex': '#E8D5B7',
      'usage': 'Backgrounds claros, containers',
    },
    {
      'name': 'Dark Orange',
      'hex': '#FF8C00',
      'usage': 'Destaques, call-to-action',
    },
    {
      'name': 'Very Dark Brown',
      'hex': '#3E2723',
      'usage': 'Textos em fundos claros',
    },
    {
      'name': 'Off White',
      'hex': '#FDFBF7',
    ...
    },
    {
      'name': 'Almost Black',
      'hex': '#1A1110',
      'usage': 'Background principal (escuro)',
    },
    {
      'name': 'Light Brown (Dark)',
      'hex': '#D7B899',
      'usage': 'Primary no modo escuro',
    },
    {
      'name': 'Light Orange',
      'hex': '#FFAB91',
      'usage': 'Tertiary no modo escuro',
    },
    {
      'name': 'Very Light Beige',
      'hex': '#EDE0DB',
      'usage': 'Textos em fundos escuros',
    },
  ];
}
