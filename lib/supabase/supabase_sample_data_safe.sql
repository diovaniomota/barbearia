-- Sample Data for Barbershop App - Safe Migration
-- This file safely inserts sample data without conflicts
...
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Mike Johnson')
AND NOT EXISTS (
...
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Mike Johnson'), 3, '09:00:00', '17:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Mike Johnson')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
    WHERE barber_id = (SELECT id FROM public.barbers WHERE name = 'Mike Johnson')
...
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Mike Johnson'), 4, '09:00:00', '17:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Mike Johnson')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
    WHERE barber_id = (SELECT id FROM public.barbers WHERE name = 'Mike Johnson')
...
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Mike Johnson'), 5, '09:00:00', '17:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Mike Johnson')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
    WHERE barber_id = (SELECT id FROM public.barbers WHERE name = 'Mike Johnson')
...
-- Lisa Davis availability
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Lisa Davis'), 1, '10:00:00', '18:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Lisa Davis')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
...
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Lisa Davis'), 2, '10:00:00', '18:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Lisa Davis')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
    WHERE barber_id = (SELECT id FROM public.barbers WHERE name = 'Lisa Davis')
...
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Lisa Davis'), 4, '10:00:00', '18:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Lisa Davis')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
    WHERE barber_id = (SELECT id FROM public.barbers WHERE name = 'Lisa Davis')
...
-- Chris Evans availability
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Chris Evans'), 2, '08:00:00', '16:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Chris Evans')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
...
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Chris Evans'), 3, '08:00:00', '16:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Chris Evans')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
    WHERE barber_id = (SELECT id FROM public.barbers WHERE name = 'Chris Evans')
...
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Chris Evans'), 5, '08:00:00', '16:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Chris Evans')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
    WHERE barber_id = (SELECT id FROM public.barbers WHERE name = 'Chris Evans')
...
INSERT INTO public.barber_availability (barber_id, day_of_week, start_time, end_time, is_available)
SELECT (SELECT id FROM public.barbers WHERE name = 'Chris Evans'), 6, '08:00:00', '14:00:00', TRUE
WHERE EXISTS (SELECT 1 FROM public.barbers WHERE name = 'Chris Evans')
AND NOT EXISTS (
    SELECT 1 FROM public.barber_availability
    WHERE barber_id = (SELECT id FROM public.barbers WHERE name = 'Chris Evans')
